...
public class MySettingsFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener,
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (bundle != null) {
            ...
            comp = bundle.getString("provider");
        }
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        Log.i(FRAGMENT_TAG, "onDisplayPreferenceDialog activated");
        ...
        if (preference instanceof NumberPickerPreference) {
            f = NumberPickerPreferenceDialogFragment.newInstance(preference.getKey(), widgetId, comp);
        } else if (preference instanceof TextAutoCompletePreference) {
            f = TextAutoCompletePreferenceDialogFragment.newInstance(preference.getKey(), widgetId, comp);
        } else
            f = null;
        if (f != null) {
    ...
    private void savePreferences(String key, String value) {
        SharedPreferences myPreferences = this.getActivity().getSharedPreferences(
    ...
    private void getLocation() {
        Log.i(FRAGMENT_TAG, "getLocation activated");
