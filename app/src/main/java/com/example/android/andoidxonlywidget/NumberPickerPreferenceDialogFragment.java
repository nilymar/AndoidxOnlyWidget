...
public class NumberPickerPreferenceDialogFragment extends PreferenceDialogFragmentCompat {
    ...
    @NonNull
    public static NumberPickerPreferenceDialogFragment newInstance(@NonNull String key, int id, String comp) {
        final NumberPickerPreferenceDialogFragment fragment = new NumberPickerPreferenceDialogFragment();
        final Bundle args = new Bundle(1);
        args.putString(ARG_KEY, key);
        args.putString("provider", comp);
    ...
    protected void onBindDialogView(@NonNull View view) {
        ...
        mValue = Integer.parseInt(restorePreferences(getResources().getString(R.string.settings_forecast_days_key)));
    ...
    public void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
            ...
            savePreferences(getResources().getString(R.string.settings_forecast_days_key), value);
